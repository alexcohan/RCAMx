     ...
     &  CONC,STK1,HRS1,SPECIES1)
      ...
      integer MAXS,istag,I,J,K,HR,L,NI,NSTK,IX



      open(9,file=ifile,status='old',form='unformatted')
...
c        READ(9) idum, SPECIEN, ((CONC(NI+I+(J-1)*NX),I=1,NX),J=1,NY)
     ...
     & ENDTIME,MSPEC)
      ...
      character*200 ifile
      CHARACTER*4 FILNAM(10),FILEID(60)
      CHARACTER*4 SPECIEN(10),MSPECB(10,200)
      CHARACTER MSPEC(10,200)
      REAL BEGTIME, ENDTIME,plon,plat
      REAL XORG,YORG,DX,DY,tlat1,tlat2,rdum
      integer NX, NY, NZ, IDATA, IDATB, idum
      integer MAXS,istag,I,J,K,HR,L
...
c      DO I=1,10
     ...
     & ENDTIME,ifile2)
      ...
      REAL XORG,YORG,DX,DY,tlat1,tlat2,rdum
      integer NX, NY, NZ, IDATA, IDATB, idum
      integer MAXS,istag,I,J,K,HR,L,NSTK
